...
module.exports = {
   ...
   'step_1.1 Validate DB': function (browser) {
    ...
    'step_7 Assert menuBarWrh has all  menu choices tests': function (browser) {               //Склад
        ...
        mainPage
            .click('@menuBarWrh')
            .waitForElementPresent("@menuBarWrhPInvoices")
            .assert.containsText('@menuBarWrhPInvoices', "Приходные накладные")
            .assert.containsText('@menuBarWrhInvoices', "Расходные накладные")
            .assert.containsText('@menuBarWrhRetInvoices', "Возвратные накладные")
            .assert.containsText('@menuBarWrhProdsBalance', "Остатки товара")
            .assert.containsText('@menuBarWrhProdsMoves', "Движение товаров")
    },
    ...
    'step_15 Main Dirs Contractors Tests': function (browser) {
        var mainPage = browser.page.mainPage();
        mainPage
            .waitForElementVisible('@menuBarPopupMenuMain')
            .click('@menuBarPopupMenuMain')
    ...
    'step_16 Assert Main Contractors BUYERS are visible': function (browser) {
        var mainPage = browser.page.mainPage();
        mainPage
    ...
    'step_17 Add new Contractor ': function (browser) {
        var mainPage = browser.page.mainPage();
        mainPage
    ...
    'step_18 Assert new contractor saved to "Other Contractors Table"': function (browser) {
        var mainPage = browser.page.mainPage();
        mainPage
    ...
    'step_19 Change Contractors Values': function (browser) {
        var mainPage = browser.page.mainPage();
        mainPage
    ...
    'step_20 Check if changed was saved in "Other Contractors Table"': function (browser) {
        var mainPage = browser.page.mainPage();
        mainPage
            .clickRefreshBtnInTable('dir_contractors')
    ...
    'step_21 Set Supplier  tip to the Contractor': function (browser) {
        var mainPage = browser.page.mainPage();
        mainPage
            .waitForElementVisible("@dir_contractors_TableDirContractors")
            .moveToCell('dir_contractors', 1, 1)
    ...
    'step_22 Mark new Contractor AS BUYER too': function (browser) {
        var mainPage = browser.page.mainPage();
        mainPage
            .waitForElementVisible("@dir_contractors_TableDirContractors")
    ...
    'step_23 Delete Contractor': function (browser) {
        var mainPage = browser.page.mainPage();
        mainPage
            .moveToCell('dir_contractors', 2, 1)
            .mouseButtonClick()
    ...
    'step_24 Right click menu tests add and save new rows': function (browser) {
        var mainPage = browser.page.mainPage();
        mainPage
            .click('@menuBarPopupMenuMain')
            .waitForElementVisible('@menuBarDirsItemUnits')
    ...
    'step_25 Right click menu change rows': function (browser) {
        var mainPage = browser.page.mainPage();
        mainPage
    ...
    'step_26 Right click menu delete rows': function (browser) {
        var mainPage = browser.page.mainPage();
        mainPage
            .moveToCell('dir_units', 4, 1)
            .mouseButtonClick()
    ...
    'step_27 Print table tests': function (browser) {
        var mainPage = browser.page.mainPage();
        mainPage
    ...
    'step_28 Open pinvs table': function (browser) {
        var mainPage = browser.page.mainPage();
        var pinvs = browser.page.pinvs();
        mainPage
            .waitForElementVisible('@menuBarWrh')
            .click('@menuBarWrh')
            .waitForElementVisible('@menuBarWrhPInvoices')
            .click('@menuBarWrhPInvoices');
        pinvs
            .waitForElementVisible('@wrh_pinv_DetailHeader');
    },
    'step_29 Pinvs check if DetailHeader elements are visible': function (browser) {
        var pinvs = browser.page.pinvs();
        pinvs
    ...
    'step_30 assert Pinvs  Header Contains Text': function (browser) {
        var pinvs = browser.page.pinvs();
        pinvs
    ...
    'step_31 create new pinv': function (browser) {
        var pinvs = browser.page.pinvs();
        pinvs
    ...
    'step_32 Assert new pinv added to left container': function (browser) {
        var pinvs = browser.page.pinvs();
    ...
    'step_33 change pinv and save changes': function (browser) {
        var pinvs = browser.page.pinvs();
        ...
        pinvs
            ...
            .doubleClick()
            .selectCurrencyFromList('USD (Американский доллар) ')
            .waitForElementVisible("@saveNewPinvBtn")
            .click("@saveNewPinvBtn")
            .showFullLeftContainer();
        browser
    ...
    'step_34 create second pinv': function (browser) {
        var pinvs = browser.page.pinvs();
        pinvs
            .showFullDetailContainer()
            .waitForElementVisible('@createNewPinvBtn')
    ...
    'step_35 Assert second pinv added to left container': function (browser) {
        var pinvs = browser.page.pinvs();
        var now = moment().format("DD.MM.YY");
        pinvs
            .showFullLeftContainer()
    ...
    "step_36 delete pinv num 1 and assert it doesn't exists": function (browser) {
        var pinvs = browser.page.pinvs();
        pinvs
    ...
    'step_37 Open invs table': function (browser) {
        var mainPage = browser.page.mainPage();
        var invs = browser.page.invs();
        mainPage
            .waitForElementVisible('@menuBarWrh')
            .click('@menuBarWrh')
            .waitForElementVisible('@menuBarWrhInvoices')
            .click('@menuBarWrhInvoices');
        invs
            .waitForElementVisible('@wrh_inv_DetailHeader');
    },
    'step_38 Invs check if DetailHeader elements are visible': function (browser) {
        var invs = browser.page.invs();
        invs
            .waitForElementVisible('@detailHeaderTitle')
            .assert.containsText("@detailHeaderTitle", "не выбрана")
    ...
    'step_39 assert Invs  Header Contains Text': function (browser) {
        var invs = browser.page.invs();
        invs
            .assertHeaderContainsText("1", "Номер п/п")
            .assertHeaderContainsText("2", "Код товара")
    ...
    'step_40 create new inv': function (browser) {
        var invs = browser.page.invs();
        invs
    ...
    'step_41 Assert new inv added to left container': function (browser) {
        var invs = browser.page.invs();
        var now = moment().format("DD.MM.YY");
        invs
            .showFullLeftContainer()
    ...
    'step_42 change inv and save changes': function (browser) {
        var invs = browser.page.invs();
        invs
            .showFullDetailContainer()
            .moveToElement('@currencyInput', 5, 5)
    ...
    'step_43 create second inv': function (browser) {
        var invs = browser.page.invs();
        invs
            .showFullDetailContainer()
            .waitForElementVisible('@createNewInvBtn')
    ...
    'step_44 Assert second inv added to left container': function (browser) {
        var invs = browser.page.invs();
        var now = moment().format("DD.MM.YY");
        invs
            .showFullLeftContainer()
    ...
    "step_45 delete invs  and assert they don't exists": function (browser) {
        var invs = browser.page.invs();
        invs
            .selectLeftContainerTableRow('1')
            .click('@deleteInvBtn');
    ...
    'step_46 Open ret_pinvs table': function (browser) {
        var mainPage = browser.page.mainPage();
        var ret_pinvs = browser.page.ret_pinvs();
        mainPage
            .waitForElementVisible('@menuBarWrh')
            .click('@menuBarWrh')
            .waitForElementVisible('@menuBarWrhRetPInvoices')
            .click('@menuBarWrhRetPInvoices');
        ret_pinvs
            .waitForElementVisible('@wrh_ret_pinv_DetailHeader');
    },
    'step_47 ret_pinvs check if DetailHeader elements are visible': function (browser) {
        var ret_pinvs = browser.page.ret_pinvs();
        ret_pinvs
            .waitForElementVisible('@detailHeaderTitle')
            .assert.containsText("@detailHeaderTitle", "не выбрана")
    ...
    'step_48 assert ret_pinvs  Header Contains Text': function (browser) {
        var ret_pinvs = browser.page.ret_pinvs();
        ret_pinvs
            .assertHeaderContainsText("1", "Номер п/п")
            .assertHeaderContainsText("2", "Код товара")
    ...
    'step_49 create new ret_pinv': function (browser) {
        var ret_pinvs = browser.page.ret_pinvs();
        ret_pinvs
            .waitForElementVisible('@createNewRetPinvBtn')
            .click('@createNewRetPinvBtn');
        browser.
            pause(1000);
        ret_pinvs
            .assert.containsText("@detailHeaderTitle", "Новая накладная возврата поставщику")
            .assert.containsText("@pickUpUnitInput", "офис")
            .assert.containsText("@supplierInput", "Поставщик")
            .assert.containsText("@currencyInput", "UAH (Украинская гривна)")
            .waitForElementVisible('@saveNewRetPinvBtn')
            .click("@saveNewRetPinvBtn");
        browser.
            pause(1000);
    },
    'step_50 Assert new ret_pinv added to left container': function (browser) {
        var ret_pinvs = browser.page.ret_pinvs();
        var now = moment().format("DD.MM.YY");
        ret_pinvs
            .showFullLeftContainer()
            ...
            .assertLeftContainerCellContainsText('1', '1', '1');
        browser.perform(function () {
            ret_pinvs.assertLeftContainerCellContainsText('1', '2', now);
        });
        ret_pinvs
            .assertLeftContainerCellContainsText('1', '3', 'Гл.офис')
            .assertLeftContainerCellContainsText('1', '4', 'Поставщик 1')
    ...
    'step_51 change pinv and save changes': function (browser) {
        var ret_pinvs = browser.page.ret_pinvs();
        ret_pinvs
            .showFullDetailContainer()
            .moveToElement('@currencyInput', 5, 5)
    ...
    'step_52 create second ret_pinv': function (browser) {
        var ret_pinvs = browser.page.ret_pinvs();
        ret_pinvs
            .showFullDetailContainer()
            .waitForElementVisible('@createNewRetPinvBtn')
    ...
    'step_53 Assert second ret_pinv added to left container': function (browser) {
        var ret_pinvs = browser.page.ret_pinvs();
        var now = moment().format("DD.MM.YY");
        ret_pinvs
            .showFullLeftContainer()
            .assertLeftContainerCellContainsText('2', '1', '2');
        browser.perform(function () {
            ret_pinvs.assertLeftContainerCellContainsText('2', '2', now);
        });
        ret_pinvs
            .assertLeftContainerCellContainsText('2', '3', 'Гл.офис')
            .assertLeftContainerCellContainsText('2', '4', 'Поставщик 1')
    ...
    "step_54 delete ret_pinv num 1 and assert it doesn't exists": function (browser) {
        var ret_pinvs = browser.page.ret_pinvs();
        ret_pinvs
            .selectLeftContainerTableRow('1')
            .click('@deleteRetPinvBtn');
        browser.pause(1000);
        ret_pinvs
            .assertLeftContainerCellContainsText('1', '1', '2')
            .selectLeftContainerTableRow('1')
    ...
    'step_55 Open ret_invs table': function (browser) {
        var mainPage = browser.page.mainPage();
        var ret_invs = browser.page.ret_invs();
        mainPage
            .waitForElementVisible('@menuBarWrh')
            .click('@menuBarWrh')
            .waitForElementVisible('@menuBarWrhRetInvoices')
            .click('@menuBarWrhRetInvoices');
        ret_invs
            .waitForElementVisible('@wrh_ret_inv_DetailHeader');
    },
    'step_56 Invs check if DetailHeader elements are visible': function (browser) {
        var ret_invs = browser.page.ret_invs();
        ret_invs
            .waitForElementVisible('@detailHeaderTitle')
            .assert.containsText("@detailHeaderTitle", "не выбрана")
    ...
    'step_57 assert ret_nvs  Header Contains Text': function (browser) {
        var ret_invs = browser.page.ret_invs();
        ret_invs
            .assertHeaderContainsText("1", "Номер п/п")
            .assertHeaderContainsText("2", "Код товара")
    ...
    'step_58 create new ret_inv': function (browser) {
        var ret_invs = browser.page.ret_invs();

        ret_invs
            .waitForElementVisible('@createNewRetInvBtn')
            .click('@createNewRetInvBtn');
        browser.
            pause(1000);
        ret_invs
            .assert.containsText("@detailHeaderTitle", "Новая возвратная накладная")
            .assert.containsText("@pickUpUnitInput", "офис")
            .assert.containsText("@buyerInput", "Розничный покупатель")
            .assert.containsText("@currencyInput", "UAH (Украинская гривна)")
            .waitForElementVisible('@saveNewRetInvBtn')
            .click("@saveNewRetInvBtn");
        browser.
            pause(1000);
    },
    'step_59 Assert new ret_inv added to left container': function (browser) {
        var ret_invs = browser.page.ret_invs();
        var now = moment().format("DD.MM.YY");
        ret_invs
            .showFullLeftContainer()
            ...
            .assertLeftContainerCellContainsText('1', '1', '1');
        browser.perform(function () {
            ret_invs.assertLeftContainerCellContainsText('1', '2', now)
        });
        ret_invs
            .assertLeftContainerCellContainsText('1', '3', 'Гл.офис')
            .assertLeftContainerCellContainsText('1', '4', 'Розничный покупатель')
    ...
    'step_60 change ret_inv and save changes': function (browser) {
        var ret_invs = browser.page.ret_invs();
    ...
    'step_70 create second ret_inv': function (browser) {
        var ret_invs = browser.page.ret_invs();
        ret_invs
            .showFullDetailContainer()
            .waitForElementVisible('@createNewRetInvBtn')
    ...
    'step_80 Assert second ret_inv added to left container': function (browser) {
        var ret_invs = browser.page.ret_invs();
        var now = moment().format("DD.MM.YY");
        ret_invs
            .showFullLeftContainer()
            .assertLeftContainerCellContainsText('2', '1', '2');
        browser.perform(function () {
            ret_invs.assertLeftContainerCellContainsText('2', '2', now)
        });
        ret_invs
            .assertLeftContainerCellContainsText('2', '3', 'Гл.офис')
            .assertLeftContainerCellContainsText('2', '4', 'Розничный покупатель')
    ...
    "step_81 delete ret_invs  and assert they don't exists": function (browser) {
        var ret_invs = browser.page.ret_invs();
        ret_invs
            .selectLeftContainerTableRow('1')
            .click('@deleteRetInvBtn');
        browser.pause(1000);
        ret_invs
            .assertLeftContainerCellContainsText('1', '1', '2')
            .selectLeftContainerTableRow('1')
