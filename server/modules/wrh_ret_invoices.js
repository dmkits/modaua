...
module.exports.validateModule = function(errs, nextValidateModuleCallback){
    dataModel.initValidateDataModels({"wrh_ret_invs":wrh_ret_invs,"wrh_ret_invs_products":wrh_ret_invs_products},
        errs,
        function(){
...
module.exports.init = function(app){
    ...
    app.get("/wrh/ret_invoices/getNewRetInvData", function(req, res){
        wrh_ret_invs.getDataItem({fieldFunction:{name:"MAXNUMBER", function:"maxPlus1", sourceField:"NUMBER"},
                conditions:{"1=1":null}},
            function(result){
