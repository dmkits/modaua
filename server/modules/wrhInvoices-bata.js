...
module.exports.init = function(app){
    ...
    var wrhInvProductsTableColumns=[
        ...
        //    dataSource:"wrh_invs", sourceField:"SUPPLIER_ID", linkCondition:"wrh_pinvs.ID=wrh_pinvs_products.PINV_ID" },
        ...
        {"data": "POS", "name": "№ п/п", "width": 45, "type": "numeric", dataFunction:"TRUNCATE(POSIND,0)"},
        ...
        {"data": "PRODUCT_CODE", "name": "Код товара", "width": 65, "type": "text", visible:true,
            dataSource:"dir_products", sourceField:"CODE"},
        {"data": "PRODUCT_NAME", "name": "Товар", "width": 250, "type": "text", visible:true,
        ...
        {"data": "PRODUCT_UM", "name": "Ед. изм.", "width": 55, "type": "text", visible:true,
