...
var changeLog = [
    { changeID:"wrh_invs__1", changeDatetime:"2017-05-04 09:01:00", changeObj:"wrh_invs",
        changeVal:"CREATE TABLE wrh_invs(ID BIGINT UNSIGNED NOT NULL PRIMARY KEY) CHARACTER SET utf8",
        tableName:"wrh_invs", field:"ID"},
    { changeID:"wrh_invs__2", changeDatetime:"2017-05-04 09:02:00", changeObj:"wrh_invs",
        changeVal:"ALTER TABLE wrh_invs ADD COLUMN NUMBER INTEGER UNSIGNED NOT NULL",
        field:"NUMBER"},
    { changeID:"wrh_invs__3", changeDatetime:"2017-05-04 09:03:00", changeObj:"wrh_invs",
        changeVal:"ALTER TABLE wrh_invs ADD COLUMN DOCDATE DATE NOT NULL",
        field:"DOCDATE"},
    { changeID:"wrh_invs__4", changeDatetime:"2017-05-04 09:04:00", changeObj:"wrh_invs",
        changeVal:"ALTER TABLE wrh_invs ADD COLUMN UNIT_ID BIGINT UNSIGNED NOT NULL",
        field:"UNIT_ID"},
    { changeID:"wrh_invs__5", changeDatetime:"2017-05-04 09:05:00", changeObj:"wrh_invs",
        changeVal:"ALTER TABLE wrh_invs ADD CONSTRAINT WRH_INVS_UNIT_ID_FK " +
            "FOREIGN KEY (UNIT_ID) REFERENCES dir_units(ID)",
        field:"UNIT_ID", "source":"dir_units", "linkField":"ID" },
    { changeID:"wrh_invs__6", changeDatetime:"2017-05-04 09:06:00", changeObj:"wrh_invs",
    ...
    { changeID:"wrh_invs__8", changeDatetime:"2017-05-04 09:08:00", changeObj:"wrh_invs",
        ...
        field:"CURRENCY_ID"},
    { changeID:"wrh_invs__9", changeDatetime:"2017-05-04 09:09:00", changeObj:"wrh_invs",
        changeVal:"ALTER TABLE wrh_invs ADD CONSTRAINT WRH_INVS_CURRENCY_ID_FK " +
            "FOREIGN KEY (CURRENCY_ID) REFERENCES sys_currency(ID)",
        field:"CURRENCY_ID", "source":"sys_currency", "linkField":"ID" },
    { changeID:"wrh_invs_10", changeDatetime:"2017-05-04 09:10:00", changeObj:"wrh_invs",
        changeVal:"ALTER TABLE wrh_invs ADD COLUMN DOCSTATE_ID INTEGER NOT NULL",
        field:"DOCSTATE_ID"},
    { changeID:"wrh_invs_11", changeDatetime:"2017-05-04 09:11:00", changeObj:"wrh_invs",
        changeVal:"ALTER TABLE wrh_invs ADD CONSTRAINT WRH_INVS_DOCSTATE_ID_FK " +
