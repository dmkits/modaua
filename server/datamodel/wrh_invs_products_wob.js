...
var changeLog = [
    ...
    { 'changeID':'wrh_invs_products_wob__2', 'changeDatetime':'2017-06-09 14:02:00', 'changeObj':'wrh_invs_products_wob',
        'changeVal':'ALTER TABLE wrh_invs_products_wob ADD COLUMN INV_PRODUCTS_ID BIGINT UNSIGNED NOT NULL',
    ...
    { 'changeID':'wrh_invs_products_wob__3', 'changeDatetime':'2017-06-09 14:03:00', 'changeObj':'wrh_invs_products_wob',
        'changeVal':'ALTER TABLE wrh_invs_products_wob ADD CONSTRAINT WRH_INVS_PRODUCTS_WOB_INV_PRODUCTS_ID_FK ' +
            'FOREIGN KEY (INV_PRODUCTS_ID) REFERENCES wrh_invs_products(ID)' },
