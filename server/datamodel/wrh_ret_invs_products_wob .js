...
var changeLog = [
    ...
    { 'changeID':'wrh_ret_inv_products_wob__3', 'changeDatetime':'2017-08-11 10:23:00', 'changeObj':'wrh_ret_inv_products_wob',
        'changeVal':'ALTER TABLE wrh_ret_inv_products_wob ADD CONSTRAINT WRH_RET_INV_PRODUCTS_WOB_INV_PRODUCTS_ID_FK ' +
            'FOREIGN KEY (RET_INV_PRODUCTS_ID) REFERENCES wrh_ret_inv_products(ID)' },
