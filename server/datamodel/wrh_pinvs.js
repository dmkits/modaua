var changeLog = [
    { 'changeID':'wrh_pinvs__1', 'changeDatetime':'2016-09-07T10:01:00.000+0300', 'changeObj':'wrh_pinvs',
        'changeVal':'CREATE TABLE wrh_pinvs(ID BIGINT UNSIGNED NOT NULL PRIMARY KEY) CHARACTER SET utf8',
        "tableName":"wrh_pinvs", "field":"ID"},
    { 'changeID':'wrh_pinvs__2', 'changeDatetime':'2016-09-07T10:02:00.000+0300', 'changeObj':'wrh_pinvs',
        'changeVal':'ALTER TABLE wrh_pinvs ADD COLUMN NUMBER INTEGER NOT NULL',
        "field":"NUMBER"},
    { 'changeID':'wrh_pinvs__3', 'changeDatetime':'2016-09-07T10:03:00.000+0300', 'changeObj':'wrh_pinvs',
        'changeVal':'ALTER TABLE wrh_pinvs ADD COLUMN DOCDATE TIMESTAMP NOT NULL',
        "field":"DOCDATE"},
    { 'changeID':'wrh_pinvs__4', 'changeDatetime':'2016-09-07T10:04:00.000+0300', 'changeObj':'wrh_pinvs',
        'changeVal':'ALTER TABLE wrh_pinvs ADD COLUMN SUPPLIER_INV_NUM VARCHAR(255) NOT NULL',
        "field":"SUPPLIER_INV_NUM"},
    { 'changeID':'wrh_pinvs__5', 'changeDatetime':'2016-09-07T10:05:00.000+0300', 'changeObj':'wrh_pinvs',
        'changeVal':'ALTER TABLE wrh_pinvs ADD COLUMN DOCSTATE_ID INTEGER NOT NULL',
        "field":"DOCSTATE_ID"},
    { 'changeID':'wrh_pinvs__6', 'changeDatetime':'2016-09-07T10:06:00.000+0300', 'changeObj':'wrh_pinvs',
    ...
    { 'changeID':'wrh_pinvs__7', 'changeDatetime':'2016-09-07T10:07:00.000+0300', 'changeObj':'wrh_pinvs',
        'changeVal':'ALTER TABLE wrh_pinvs ADD COLUMN CURRENCY_ID INTEGER NOT NULL',
        "field":"CURRENCY_ID"},
    { 'changeID':'wrh_pinvs__8', 'changeDatetime':'2016-09-07T10:08:00.000+0300', 'changeObj':'wrh_pinvs',
    ...
    { 'changeID':'wrh_pinvs__9', 'changeDatetime':'2016-09-07T10:09:00.000+0300', 'changeObj':'wrh_pinvs',
        'changeVal':'ALTER TABLE wrh_pinvs ADD COLUMN RATE DECIMAL(10,2) NOT NULL',
        "field":"RATE"},
    { 'changeID':'wrh_pinvs_10', 'changeDatetime':'2016-09-07T10:10:00.000+0300', 'changeObj':'wrh_pinvs',
        'changeVal':'ALTER TABLE wrh_pinvs ADD COLUMN BASE_FACTOR DECIMAL(10,2) NOT NULL',
        "field":"BASE_FACTOR"},
    { 'changeID':'wrh_pinvs_11', 'changeDatetime':'2016-09-07T10:11:00.000+0300', 'changeObj':'wrh_pinvs',
        'changeVal':'ALTER TABLE wrh_pinvs ADD COLUMN UNIT_ID BIGINT UNSIGNED NOT NULL',
        "field":"UNIT_ID"},
    { 'changeID':'wrh_pinvs_12', 'changeDatetime':'2016-09-07T10:12:00.000+0300', 'changeObj':'wrh_pinvs',
    ...
    { 'changeID':'wrh_pinvs_13', 'changeDatetime':'2016-09-07T10:13:00.000+0300', 'changeObj':'wrh_pinvs',
        'changeVal':'ALTER TABLE wrh_pinvs ADD COLUMN SUPPLIER_ID BIGINT UNSIGNED NOT NULL',
        "field":"SUPPLIER_ID"},
    { 'changeID':'wrh_pinvs_14', 'changeDatetime':'2016-09-07T10:14:00.000+0300', 'changeObj':'wrh_pinvs',
    ...
    { 'changeID':'wrh_pinvs_15', 'changeDatetime':'2016-09-12T09:46:00.000+0300', 'changeObj':'wrh_pinvs',
        'changeVal':'ALTER TABLE wrh_pinvs ADD COLUMN COLLECTION_ID BIGINT UNSIGNED NOT NULL',
        "field":"COLLECTION_ID"},
    { 'changeID':'wrh_pinvs_16', 'changeDatetime':'2016-09-12T09:47:00.000+0300', 'changeObj':'wrh_pinvs',
