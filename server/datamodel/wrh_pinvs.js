...
var changeLog = [
    ...
    { 'changeID':'wrh_pinvs__2', 'changeDatetime':'2016-09-07 10:02:00', 'changeObj':'wrh_pinvs',
        'changeVal':'ALTER TABLE wrh_pinvs ADD CONSTRAINT WRH_PINVS_R_DOCUMENTS_ID_FK' +
        ' FOREIGN KEY (ID) REFERENCES wrh_r_documents(ID)',
    ...
    { 'changeID':'wrh_pinvs_14', 'changeDatetime':'2016-09-07 10:14:00', 'changeObj':'wrh_pinvs',
        ...
        "field":"SUPPLIER_ID"},
    { 'changeID':'wrh_pinvs_15', 'changeDatetime':'2016-09-07 10:15:00', 'changeObj':'wrh_pinvs',
    ...
    { 'changeID':'wrh_pinvs_16', 'changeDatetime':'2016-09-12 09:46:00', 'changeObj':'wrh_pinvs',
        'changeVal':'ALTER TABLE wrh_pinvs ADD COLUMN COLLECTION_ID BIGINT UNSIGNED NOT NULL',
        "field":"COLLECTION_ID"},
    { 'changeID':'wrh_pinvs_17', 'changeDatetime':'2016-09-12 09:47:00', 'changeObj':'wrh_pinvs',
    ...
    { 'changeID':'wrh_pinvs_18', 'changeDatetime':'2016-09-12 22:20:00', 'changeObj':'wrh_pinvs',
        'changeVal':'ALTER TABLE wrh_pinvs ADD COLUMN SUPPLIER_ORDER_NUM VARCHAR(255)',
        "field":"SUPPLIER_ORDER_NUM"},
    { "changeID": "wrh_pinvs_19", "changeDatetime": "2016-09-12 22:21:00", "changeObj": "wrh_pinvs",
