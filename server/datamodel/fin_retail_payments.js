var changeLog = [
    { 'changeID':'fin_retail_payments__1', 'changeDatetime':'2016-09-26 21:31:00', 'changeObj':'model.fin_retail_payments',
    ...
    { 'changeID':'fin_retail_payments__2', 'changeDatetime':'2016-09-26 21:32:00', 'changeObj':'model.fin_retail_payments',
        'changeVal':'ALTER TABLE fin_retail_payments ADD COLUMN RETAIL_RECEIPT_ID BIGINT UNSIGNED NOT NULL',
        "field":"RETAIL_RECEIPT_ID"},
    { 'changeID':'fin_retail_payments__3', 'changeDatetime':'2016-09-26 21:33:00', 'changeObj':'model.fin_retail_payments',
    ...
    { 'changeID':'fin_retail_payments__4', 'changeDatetime':'2016-09-26 21:34:00', 'changeObj':'model.fin_retail_payments',
        'changeVal':'ALTER TABLE fin_retail_payments ADD COLUMN DOCSUM DECIMAL(12,2) NOT NULL',
        "field":"DOCSUM"},
    { 'changeID':'fin_retail_payments__5', 'changeDatetime':'2016-09-26 21:35:00', 'changeObj':'model.fin_retail_payments',
        'changeVal':'ALTER TABLE fin_retail_payments ADD COLUMN PAYMENT_FORM_CODE INTEGER NOT NULL',
        "field":"PAYMENT_FORM_CODE"},
    { 'changeID':'fin_retail_payments__6', 'changeDatetime':'2017-06-27 08:15:00', 'changeObj':'model.fin_retail_payments',
...
{ 'changeID':'fin_retail_payments__7', 'changeDatetime':'2017-06-27 12:50:00', 'changeObj':'model.fin_retail_payments',
