var changeLog = [
{ 'changeID':'wrh_ret_inv_products_wob__1', 'changeDatetime':'2017-08-11 10:21:00', 'changeObj':'model.wrh_ret_inv_products_wob',
...
{ 'changeID':'wrh_ret_inv_products_wob__2', 'changeDatetime':'2017-08-11 10:22:00', 'changeObj':'model.wrh_ret_inv_products_wob',
...
{ 'changeID':'wrh_ret_inv_products_wob__3', 'changeDatetime':'2017-08-11 10:23:00', 'changeObj':'model.wrh_ret_inv_products_wob',
...
{ 'changeID':'wrh_ret_inv_products_wob__4', 'changeDatetime':'2017-08-11T10:24:00', 'changeObj':'model.wrh_ret_inv_products_wob',
    'changeVal':'ALTER TABLE wrh_ret_inv_products_wob ADD COLUMN BATCH_NUMBER INTEGER NOT NULL',
    "field":"BATCH_NUMBER"},
{ 'changeID':'wrh_ret_inv_products_wob__5', 'changeDatetime':'2017-08-11 10:25:00', 'changeObj':'model.wrh_ret_inv_products_wob',
