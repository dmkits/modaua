...
var changeLog = [
    ...
    { 'changeID':'wrh_ret_invs_products_wob__2', 'changeDatetime':'2017-08-11 10:22:00', 'changeObj':'wrh_ret_invs_products_wob',
        'changeVal':'ALTER TABLE wrh_ret_invs_products_wob ADD COLUMN RET_INV_PRODUCTS_ID BIGINT UNSIGNED NOT NULL',
    ...
    { 'changeID':'wrh_ret_invs_products_wob__3', 'changeDatetime':'2017-08-11 10:23:00', 'changeObj':'wrh_ret_invs_products_wob',
        'changeVal':'ALTER TABLE wrh_ret_invs_products_wob ADD CONSTRAINT WRH_RET_INVS_PRODUCTS_WOB_INV_PRODUCTS_ID_FK ' +
            'FOREIGN KEY (RET_INV_PRODUCTS_ID) REFERENCES wrh_ret_invs_products(ID)' },
