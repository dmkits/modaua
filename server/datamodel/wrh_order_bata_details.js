var changeLog=[
    { "changeID": "wrh_order_bata_details__1", "changeDatetime": "2016-09-04 20:01:00", "changeObj": "wrh_order_bata_details",
    ...
    { "changeID": "wrh_order_bata_details__2", "changeDatetime": "2016-09-04 20:02:00", "changeObj": "wrh_order_bata_details",
        "changeVal": "ALTER TABLE wrh_order_bata_details ADD COLUMN ORDER_BATA_ID BIGINT UNSIGNED NOT NULL",
        "field":"ORDER_BATA_ID" },
    { "changeID": "wrh_order_bata_details__3", "changeDatetime": "2016-09-04 20:03:00", "changeObj": "wrh_order_bata_details",
    ...
    { "changeID": "wrh_order_bata_details__4", "changeDatetime": "2016-09-04 20:04:00", "changeObj": "wrh_order_bata_details",
        "changeVal": "ALTER TABLE wrh_order_bata_details ADD COLUMN POS INTEGER UNSIGNED NOT NULL NOT NULL",
        "field":"POS" },
    { "changeID": "wrh_order_bata_details__5", "changeDatetime": "2016-09-04 20:05:00", "changeObj": "wrh_order_bata_details",
    ...
    { "changeID": "wrh_order_bata_details__6", "changeDatetime": "2016-09-04 20:06:00", "changeObj": "wrh_order_bata_details",
    ...
    { "changeID": "wrh_order_bata_details__7", "changeDatetime": "2016-09-04 20:07:00", "changeObj": "wrh_order_bata_details",
        "changeVal": "ALTER TABLE wrh_order_bata_details ADD COLUMN PRODUCT_CATEGORY_ID BIGINT UNSIGNED NOT NULL",
        "field":"PRODUCT_CATEGORY_ID" },
    { "changeID": "wrh_order_bata_details__8", "changeDatetime": "2016-09-04 20:08:00", "changeObj": "wrh_order_bata_details",
    ...
    { "changeID": "wrh_order_bata_details__9", "changeDatetime": "2016-09-04 20:09:00", "changeObj": "wrh_order_bata_details",
    ...
    { "changeID": "wrh_order_bata_details_10", "changeDatetime": "2016-09-04 20:10:00", "changeObj": "wrh_order_bata_details",
    ...
    { "changeID": "wrh_order_bata_details_11", "changeDatetime": "2016-09-04 20:11:00", "changeObj": "wrh_order_bata_details",
        "changeVal": "ALTER TABLE wrh_order_bata_details ADD COLUMN QTY DECIMAL(12,3) NOT NULL",
        "field":"QTY" },
    { "changeID": "wrh_order_bata_details_12", "changeDatetime": "2016-09-04 20:22:00", "changeObj": "wrh_order_bata_details",
        "changeVal": "ALTER TABLE wrh_order_bata_details ADD COLUMN RETAIL_PRICE DECIMAL(12,4) NOT NULL",
        "field":"RETAIL_PRICE" },
    { "changeID": "wrh_order_bata_details_13", "changeDatetime": "2016-09-04 20:23:00", "changeObj": "wrh_order_bata_details",
        "changeVal": "ALTER TABLE wrh_order_bata_details ADD COLUMN PRICE DECIMAL(12,4) NOT NULL",
        "field":"PRICE" },
    { "changeID": "wrh_order_bata_details_14", "changeDatetime": "2016-09-04 20:24:00", "changeObj": "wrh_order_bata_details",
        "changeVal": "ALTER TABLE wrh_order_bata_details ADD COLUMN POSSUM DECIMAL(12,2) NOT NULL",
        "field":"POSSUM" },
    { "changeID": "wrh_order_bata_details_15", "changeDatetime": "2016-09-11 16:31:00", "changeObj": "wrh_order_bata_details",
    ...
    { "changeID": "wrh_order_bata_details_16", "changeDatetime": "2016-09-11 16:32:00", "changeObj": "wrh_order_bata_details",
