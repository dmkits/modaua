...
var tableName="wrh_order_bata_details", tableFields=["ID","ORDER_BATA_ID","POS","PRODUCT_GENDER_ID",
  "PRODUCT_CATEGORY_ID","PRODUCT_ARTICLE_ID", "QTY","RETAIL_PRICE","PRICE","POSSUM", "PRODUCT_SUBCATEGORY_ID"], idField=tableFields[0];
