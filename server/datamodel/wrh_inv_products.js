var changeLog = [
    ...
    { 'changeID':'wrh_inv_products__4', 'changeDatetime':'2017-05-04T09:18:00.000+0300', 'changeObj':'model.wrh_inv_products',
    ...
    { 'changeID':'wrh_inv_products__7', 'changeDatetime':'2017-05-04T09:21:00.000+0300', 'changeObj':'model.wrh_inv_products',
        'changeVal':'ALTER TABLE wrh_inv_products ADD COLUMN QTY DECIMAL(12,3) NOT NULL',
        "field":"QTY"},
    { 'changeID':'wrh_inv_products__8', 'changeDatetime':'2017-05-04T09:22:00.000+0300', 'changeObj':'model.wrh_inv_products',
        'changeVal':'ALTER TABLE wrh_inv_products ADD COLUMN PRICE DECIMAL(12,2) NOT NULL',
        "field":"PRICE"},
    { 'changeID':'wrh_inv_products__9', 'changeDatetime':'2017-05-04T09:23:00.000+0300', 'changeObj':'model.wrh_inv_products',
