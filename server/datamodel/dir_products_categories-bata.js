var changeLog=[
    { "changeID":"dir_products_categories__1", "changeDatetime": "2016-08-31T18:15:00.000+0300", "changeObj": "dir_products_categories",
        "changeVal": "CREATE TABLE dir_products_categories(ID BIGINT NOT NULL PRIMARY KEY) CHARACTER SET utf8" },
    ...
    { "changeID":"dir_products_categories__6", "changeDatetime": "2016-09-11T20:01:00.000+0300", "changeObj": "dir_products_categories",
        "changeVal": "ALTER TABLE dir_products_categories ADD COLUMN GENDER_ID BIGINT NOT NULL" },
...
var tableColumns=[
    ...
    {"data": "GENDER_CODE", "name": "Код группы", "width": 90, "type": "text"},
    {"data": "GENDER_NAME", "name": "Наименование группы", "width": 200, "type": "text"},
