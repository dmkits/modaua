...
var changeLog = [
    { 'changeID':'wrh_pinv_products__1', 'changeDatetime':'2016-09-08T11:31:00.000+0300', 'changeObj':'wrh_pinv_products',
    ...
    { 'changeID':'wrh_pinv_products__2', 'changeDatetime':'2016-09-08T11:32:00.000+0300', 'changeObj':'wrh_pinv_products',
        'changeVal':'ALTER TABLE wrh_pinv_products ADD COLUMN PINV_ID BIGINT UNSIGNED NOT NULL',
        "field":"PINV_ID"},
    { 'changeID':'wrh_pinv_products__3', 'changeDatetime':'2016-09-08T11:33:00.000+0300', 'changeObj':'wrh_pinv_products',
    ...
    { 'changeID':'wrh_pinv_products__4', 'changeDatetime':'2016-09-08T11:34:00.000+0300', 'changeObj':'wrh_pinv_products',
        'changeVal':'ALTER TABLE wrh_pinv_products ADD COLUMN POSIND FLOAT NOT NULL',
        "field":"POSIND"},
    { 'changeID':'wrh_pinv_products__5', 'changeDatetime':'2016-09-08T11:35:00.000+0300', 'changeObj':'wrh_pinv_products',
        'changeVal':'ALTER TABLE wrh_pinv_products ADD COLUMN PRODUCT_ID BIGINT UNSIGNED NOT NULL',
        "field":"PRODUCT_ID"},
    { 'changeID':'wrh_pinv_products__6', 'changeDatetime':'2016-09-08T11:36:00.000+0300', 'changeObj':'wrh_pinv_products',
    ...
    { 'changeID':'wrh_pinv_products__7', 'changeDatetime':'2016-09-08T11:37:00.000+0300', 'changeObj':'wrh_pinv_products',
        'changeVal':'ALTER TABLE wrh_pinv_products ADD COLUMN QTY DECIMAL(12,3) NOT NULL',
        "field":"QTY"},
    { 'changeID':'wrh_pinv_products__8', 'changeDatetime':'2016-09-08T11:38:00.000+0300', 'changeObj':'wrh_pinv_products',
        'changeVal':'ALTER TABLE wrh_pinv_products ADD COLUMN PRICE DECIMAL(12,4) NOT NULL',
        "field":"PRICE"},
    { 'changeID':'wrh_pinv_products__9', 'changeDatetime':'2016-09-08T11:39:00.000+0300', 'changeObj':'wrh_pinv_products',
        'changeVal':'ALTER TABLE wrh_pinv_products ADD COLUMN POSSUM DECIMAL(12,2) NOT NULL',
        "field":"POSSUM"},
    { 'changeID':'wrh_pinv_products_10', 'changeDatetime':'2016-09-08T11:40:00.000+0300', 'changeObj':'wrh_pinv_products',
    ...
    { 'changeID':'wrh_pinv_products_13', 'changeDatetime':'2016-09-08T11:43:00.000+0300', 'changeObj':'wrh_pinv_products',
        'changeVal':'ALTER TABLE wrh_pinv_products ADD COLUMN FACTOR DECIMAL(10,2) NOT NULL',
        "field":"FACTOR"},
    { 'changeID':'wrh_pinv_products_14', 'changeDatetime':'2016-09-08T11:44:00.000+0300', 'changeObj':'wrh_pinv_products',
        'changeVal':'ALTER TABLE wrh_pinv_products ADD CONSTRAINT PINV_ID_POSIND_UNIQUE' +
        ' UNIQUE(PINV_ID,POSIND)' },
    { 'changeID':'wrh_pinv_products_15', 'changeDatetime':'2017-06-09T11:11:00.000+0300', 'changeObj':'wrh_pinv_products',
        'changeVal':'ALTER TABLE wrh_pinv_products ADD COLUMN BATCH_NUMBER INTEGER UNSIGNED NOT NULL',
        "field":"BATCH_NUMBER"},
    { 'changeID':'wrh_pinv_products_16', 'changeDatetime':'2017-06-09T11:12:00.000+0300', 'changeObj':'wrh_pinv_products',
