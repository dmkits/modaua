var changeLog=[
    ...
    { "changeID": "dir_units__8", "changeDatetime": "2016-08-29 11:48:00", "changeObj": "dir_units",
        ...
        "field":"NOT_USED" },
    { "changeID": "dir_units__9", "changeDatetime": "2016-08-29 11:49:00", "changeObj": "dir_units",
        "changeVal":
            "INSERT INTO dir_units(ID,NAME,FULL_NAME,NOTE,CITY,ADDRESS,NOT_USED)" +
                " values (0,'Гл.офис','офис','офис','Днипро','Днипро',0)" },
    { "changeID": "dir_units_10", "changeDatetime": "2016-08-29 11:50:00", "changeObj": "dir_units",
        "changeVal":
            "INSERT INTO dir_units(ID,NAME,FULL_NAME,NOTE,CITY,ADDRESS,NOT_USED)" +
